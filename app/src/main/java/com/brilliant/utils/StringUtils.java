...
public class StringUtils {
    ...
    public static String replaceFilePath(String filePath) {
        ...
        if (filePath.startsWith("/sdcard") && com.brilliant.utils.SDCardUtils.getRootPath() != null) {
            filePath = filePath.replaceFirst("/sdcard", com.brilliant.utils.SDCardUtils.getRootPath());
