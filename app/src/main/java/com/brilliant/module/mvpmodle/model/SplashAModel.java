package com.brilliant.module.mvpmodle.model;
        ...
        return Api.getInstance().queryAdvert(mContext)
                .map(new Func1<QueryAdvertBean, QueryAdvertBean.DataBean>() {
                    ...
                    public QueryAdvertBean.DataBean call(QueryAdvertBean queryAdvertBean) {
                        ...
                        QueryAdvertBean.DataBean bean_old = SPUtils.getSharedObject(Constant.KEY_SPLASH_ADVERTISEMENT, null);
                        ...
                        SPUtils.setSharedObject(Constant.KEY_SPLASH_ADVERTISEMENT, bean_new);
